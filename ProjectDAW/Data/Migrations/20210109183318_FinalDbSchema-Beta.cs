...
{
    public partial class FinalDbSchemaBeta : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserGameFavourite", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserGameFavourite_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserGameFavourite_Game_GameId",
                        column: x => x.GameId,
                        principalTable: "Game",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserGameFavourite_GameId",
                table: "UserGameFavourite",
                column: "GameId");

            migrationBuilder.CreateIndex(
                name: "IX_UserGameFavourite_UserId",
                table: "UserGameFavourite",
                column: "UserId");
        }
